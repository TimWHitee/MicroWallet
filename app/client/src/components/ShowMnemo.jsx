        ...
        <>
          ...
          {!isReady ? (
            ...
            <div className="mnemonic-verification">
              <h3>Please enter the 2nd, 7th, and 11th words of your mnemonic phrase:</h3>
              <input
                type="text"
              ...
              {isVerified && <p style={{ color: 'green' }}>Verification successful!</p>}
              {error && <p>The words you entered do not match. Please try again.</p>}
            </div>
          )}
        </>
      ) : (
